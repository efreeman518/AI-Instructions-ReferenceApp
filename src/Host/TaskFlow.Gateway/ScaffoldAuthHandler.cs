...
/// <summary>Authenticates every scaffold request with the reference app's predictable identity.</summary>
public sealed class ScaffoldAuthHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    /// <summary>Creates the automatic principal used by login-free reference app requests.</summary>
