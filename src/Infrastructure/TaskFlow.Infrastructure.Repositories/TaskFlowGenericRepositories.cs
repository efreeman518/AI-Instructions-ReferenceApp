...
/// per-entity repository class. Closes the three-parameter <see cref="RepositoryTrxn{TEntity, TId, TDbContext}"/>
/// over <see cref="TaskFlowDbContextTrxn"/> so DI sees a two-arity open generic.
/// </summary>
