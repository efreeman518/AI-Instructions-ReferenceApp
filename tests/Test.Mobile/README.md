...
powershell -NoProfile -File tests/Test.Mobile/run-mobile-tests.ps1 -AvdName Android_Emulator_35
...
dotnet test tests/Test.Mobile/Test.Mobile.csproj --no-build --filter TestCategory=MobileUI
```
